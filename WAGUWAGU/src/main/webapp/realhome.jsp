...
<body>
	...
	<div class="tm-page-wrap">
		...
		<div class="mb-5">
			...
			<!-- 정렬 및 필터 -->
			<a href="video?act=viewCnt&category=${param.category }">조회수순</a> <a
				href="video?act=regTime&category=${param.category }">최신순</a> <a
				href="video?act=pickCnt&category=${param.category }">좋아요순</a>
			...
			<div class="video-section">
				<table width="100%" border="1" cellspacing="10" cellpadding="10">
					<c:forEach var="video" items="${videoList}" varStatus="status">
						...
						<td width="33%" align="center" valign="top"><img
							src="${video.videoImgUrl}" width="80%" height="auto"><br>
							<a href="review?act=totallist&videoId=${video.videoId }"><b>${video.videoTitle}</b></a><br>
							<small>작성자:${video.videoOwner}</small><br> <small>얼로드일:${video.videoRegDate}</small><br>
							<small>종류:${video.videoCat}</small><br> <small>난이도:${video.videoLevel}</small><br>
							<small>조회수:${video.videoViewCnt}</small><br> <small>찜:${video.pickCount}</small></td>
